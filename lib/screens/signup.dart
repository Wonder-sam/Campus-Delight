...
void confirmPasswordHandler(String text, WidgetRef ref) {
  ...
  if (ref
          ...
          .state
          .compareTo(ref.read(confirmPasswordProvider.notifier).state) ==
      0) {
...
bool containsTwoDifferentTypes(String text) {
  return containsLowerAndNumber(text) ||
      containsNumberAndSpecialCharacter(text) ||
      containsUpperAndLower(text) ||
      containsUpperAndNumber(text);
}

bool containsThreeDifferentTypes(String text) {
  return containsLowerNumberCharacter(text) ||
      containsLowerUpperCharacter(text) ||
      containsUpperNumberCharacter(text) ||
      containsUpperNumberLower(text);
}
